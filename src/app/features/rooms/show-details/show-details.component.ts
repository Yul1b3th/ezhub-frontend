...
import { NotificationAmenityComponent } from '@components/shared/notificationAmenity/notificationAmenity.component';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, NotificationAmenityComponent],
